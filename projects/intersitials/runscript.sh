...
exit 0
g++ --std=c++17 ../avdv-factor-group/lattice.cpp ../avdv-factor-group/site.cpp ../avdv-factor-group/coordinate.cpp ../avdv-factor-group/symop.cpp ../avdv-factor-group/structure.cpp write_to_poscar.cpp interstitial_mesh.cpp main.cpp -o run_main
